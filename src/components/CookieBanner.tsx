            ...
            <div className="w-full max-w-[1700px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4 sm:gap-6">
              ...
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 shrink-0 order-2 md:order-2">
                ...
                <button
                  ...
                  className="px-4 py-2 sm:py-2.5 text-zinc-300 hover:text-[#BAFC50] underline underline-offset-4 decoration-zinc-600 hover:decoration-[#BAFC50] font-sans font-medium text-xs sm:text-sm tracking-wide transition-colors duration-200 cursor-pointer"
                >
                  Uzzināt vairāk
                </button>
              </div>
