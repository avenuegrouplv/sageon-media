...
export const lvTranslations: Translations = {
  ...
  home: {
    ...
    whyChooseUsTitle: "Kāpēc izvēlēties Sageon Media?",
  ...
  cookies: {
    bannerText: "Mūsu mājaslapā tiek izmantotas sīkdatnes, lai nodrošinātu labāko lietotāja pieredzi un analītiku.",
    acceptBtn: "Pieņemt visas",
    declineBtn: "Tikai nepieciešamās",
    detailsBtn: "Sīkāka informācija",
  },
  portfolioItems: [
    {
      id: 1,
