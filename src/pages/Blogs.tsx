...
export default function Blogs() {
  ...
  return (
    <div className="min-h-screen bg-black font-sans text-left text-white relative overflow-hidden">
      ...
      <div className="absolute -top-32 -left-20 w-[850px] h-[500px] -rotate-12 rounded-[60%_40%_70%_30%] bg-gradient-to-br from-[#BAFC50]/[0.09] via-[#38b000]/[0.04] to-transparent blur-[200px] pointer-events-none z-0" />
      ...
      <div className="hidden sm:block absolute top-[22%] -left-16 w-[750px] h-[450px] -rotate-6 rounded-[50%_50%_60%_40%] bg-gradient-to-tr from-[#BAFC50]/[0.08] via-[#38b000]/[0.04] to-transparent blur-[200px] pointer-events-none z-0" />
      ...
      <div className="hidden sm:block absolute top-[48%] -left-20 w-[820px] h-[480px] -rotate-12 rounded-[60%_40%_45%_55%] bg-gradient-to-r from-[#BAFC50]/[0.08] via-[#38b000]/[0.04] to-transparent blur-[200px] pointer-events-none z-0" />
      ...
      <div className="absolute -bottom-40 left-1/3 w-[850px] h-[500px] rotate-12 rounded-[55%_45%_65%_35%] bg-gradient-to-tr from-[#BAFC50]/[0.08] via-[#38b000]/[0.04] to-transparent blur-[200px] pointer-events-none z-0" />
